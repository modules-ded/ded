...
async def clans_handler(message: types.Message):
    ...
    try:
        if (clan_id := user[16]) is None:
            ...
            inline_kb.add(*buttons)
            await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/clan.png', 'rb'),
...
async def send_page_data(chat_id, page, query, message_id=None): 
    ...
    if message_id:    
        ...
        sent_message = await bot.send_photo(chat_id=chat_id, photo=open(f'/root/bot/module-deda/exp.png', 'rb'),
...
async def case(chat_id, page, query, message_id=None): 
    ...
    if message_id:    
        ...
        sent_message = await bot.send_photo(chat_id=chat_id, photo=open(f'/root/bot/module-deda/case.png', 'rb'),
                              caption=price, reply_markup=markup, parse_mode='html')
        return sent_message.message_id 
    ...
    if page == 1:
        ...
        if chance == 1:
            ...
            if not im:
                ...
                await bot.send_photo(chat_id=chat_id, photo=open(f'/root/bot/module-deda/bot{voin}.png', 'rb'),
...
async def construct_page_message(user_id, users, total_pages, current_page, message_id=None):
    ...
    if message_id is None:
        await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/top.png', 'rb'),
...
async def handle_choose_fighter(query):
    ...
    await bot.send_photo(chat_id=query.message.chat.id, photo=open(f'/root/bot/module-deda/bot{phot}.png', 'rb'),
...
async def start_duel():
    ...
    with open(f'/root/bot/module-deda/bot{phot1}.png', 'rb') as photo1:
    ...
    with open(f'/root/bot/module-deda/bot{phot2}.png', 'rb') as photo2:
...
async def handle_attack_callback(call: types.CallbackQuery):
    ...
    if opponent_stats['health'] <= 0:
        ...
        await bot.send_photo(chat_id=player_id, photo=open(f'/root/bot/module-deda/bot{phot}.png', 'rb'),
                              caption=f"<b>Победа 🎃\n\n🥷 Воин {voin}\n🧩 Опыт +{opyt1}\n💰 Золото +{win}\n💎 Коины +{coinwin}\n\n+30 MMR</b>", parse_mode='html')
        await bot.send_photo(chat_id=opponent_id, photo=open(f'/root/bot/module-deda/bot{phot2}.png', 'rb'),
...
async def win_player(user_id, opponent_id):
    ...
    await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/bot{phot2}.png', 'rb'),
                              caption=f"<b>Вы сдались 💀\n\n🥷 Воин {voin2}\n🧩 Опыт +0\n💰 Золото +0\n\n-{30 if p2[5] >= 30 else 0} MMR</b>", parse_mode='html')
    await bot.send_photo(chat_id=opponent_id, photo=open(f'/root/bot/module-deda/bot{phot}.png', 'rb'),
...
async def voin(call: types.CallbackQuery):
    ...
    await bot.send_photo(chat_id=call.from_user.id, photo=open(f'/root/bot/module-deda/bot{cur[1]}.png', 'rb'),
...
async def shop(query):
    ...
    if id == 2:
        ...
        if not cut:
            ...
            c.execute('INSERT INTO pers VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',(user_id, 2, 0, 600, 90, 5, 10, 15, 5, 0))
            base.commit()
            await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/bot{id}.png', 'rb'),
...
async def text(msg):
    ...
    if m == 'профиль 🖼':
        ...
        await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/profile.png', 'rb'),
    ...
    if m == "воины 🥷":
        ...
        await bot.send_photo(chat_id=user_id, photo=open(f'/root/bot/module-deda/bot{phot}.png', 'rb'),
                              caption=f'<b>{chosen_voin} | 🧩 Опыт {op}\n\n❤️ Здоровье {hp}\n🔫 Урон {attack}\n🛡 Броня {shit}\n💥 Шанс крита {krit}%\n🦋 Уклонение {uklon}%\n🦇 Вампиризм {vampirism}%\n</b>',
                                reply_markup=ups)
    ...
    if m == "скам 💸":
        ...
        keb.add(ik)
        await bot.send_photo(chat_id=id, photo=open(f'/root/bot/module-deda/skam.png', 'rb'),
